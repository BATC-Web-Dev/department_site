...
<!-- start of username field -->
			...
			<tr class="tml-user-login-wrap">
				...
				<td><div id="user_login" class="display_only"><?php echo $profileuser->user_login; ?></div></td>
			</tr>
...
<!-- start of nickname field -->
			<tr class="tml-nick-name-wrap">
				<td><input type="hidden" name="nickname" id="nickname" value="<?php echo esc_attr( $profileuser->user_login ); ?>" class="regular-text" />
			</tr>
...
<!-- start of email field -->
			<?php
			$display_old_val = "";
			if ($profileuser->approve_user_email) {
				$old_email = "$profileuser->user_email";
			
				$email_field = $profileuser->approve_user_email;
				$email_label = "Email (required)- <span class='approval'>pending approval</span>";
				$display_old_val = "Your email will remain $old_email until $email_field is approved.";
			}
			else {
				$email_field = $profileuser->user_email;
				$email_label = "Email (required)";
			}
			?>
			
			<tr class="tml-user-email-wrap">
				<th><label for="approve_user_email"><?php _e( $email_label, 'theme-my-login' ); ?></label></th>
				<td><input type="text" name="approve_user_email" id="approve_user_email" value="<?php echo esc_attr( $email_field ); ?>" class="regular-text" /></td>
				<td><input type="hidden" name="email" id="email" value="<?php echo esc_attr( $profileuser->user_email ); ?>" class="regular-text" /></td>
			</tr>
<!-- end of email field -->
    ...
    jQuery(document).ready(function( $ ) {
        ...
        $('#approve_description').keyup(function() {
			...
			<tr class="tml-user-description-wrap">
				<th><label for="approve_description"><?php _e( $description_label, 'theme-my-login' ); ?></label></th><td><textarea name="approve_description" id="approve_description" +
				rows="3" cols="30" maxlength="140"><?php echo esc_html( $description_value ); ?></textarea><br /><div id="approve_textarea_feedback">info</div>
