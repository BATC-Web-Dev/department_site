...
class gdbbT_Admin {
    ...
    function upgrade_notice() {
        ...
        if ($gdbbpress_tools->o['update_wp44'] == 0) {
            ...
            echo '</div>';
        } else if ($gdbbpress_tools->o['upgrade_to_pro_180'] == 1) {
            ...
            echo '<div class="updated d4p-updated">';
                ...
                echo '<strong><a href="https://plugins.dev4press.com/plugins-pack/" target="_blank">'.__("Dev4Press Plugins Pack", "gd-bbpress-tools")."</a></strong> &middot; ";
    ...
    public function admin_init() {
        ...
        if (isset($_GET['proupgradebbt']) && $_GET['proupgradebbt'] == 'hide') {
            ...
            $gdbbpress_tools->o['upgrade_to_pro_180'] = 0;
